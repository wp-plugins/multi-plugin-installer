...
Multi plugin installer helps you release your burden of the process of installing multiple plugins one by one. You can install multiple plugins in one go with Multi Plugin Installer    
